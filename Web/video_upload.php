...
<head>
  ...
  <link href="css/video_upload.css" rel="stylesheet">
...
<body>
  ...
  <img src="img/video_upload/background_image.jpg" class="background_image">
  ...
  include 'php/video_upload_functions.php';
  ...
  function analyse(){
      shell_exec('/var/www/anaconda3/envs/posture/bin/python /var/www/sapient/Posture/featureExtraction/tf-pose-estimation/video.py');

      $output = shell_exec('cat /var/www/sapient/Web/output.txt');

	shell_exec('export GOOGLE_APPLICATION_CREDENTIALS="/var/www/sapient/FaceItem/service-account-file.json" && /var/www/anaconda3/envs/posture/bin/python /var/www/sapient/FaceItem/src/faces.py');

	shell_exec('ffmpeg -y -i /var/www/output.avi /var/www/output.mp4');

     echo '<div class="output_text">Posture Recognition:</br></br>'.$output.'</div>';
